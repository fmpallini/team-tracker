...
const pt = {
  ...
  prefs_backup_label: 'Manter backup diário (.bck)',
  prefs_backup_hint: 'Cria/atualiza um arquivo .bck, no máximo uma vez a cada 24 horas — uma segunda linha de defesa contra corrupção de arquivo. O seletor de arquivo sugere a mesma pasta do arquivo original, mas você pode escolher outro local. Renomeie o .bck para .tmv para abri-lo normalmente.',
...
const en: Record<MsgKey, string> = {
  ...
  prefs_backup_label: 'Maintain daily backup file (.bck)',
  prefs_backup_hint: 'Creates/updates a .bck file, at most once every 24 hours — a second line of defense against file corruption. The file picker suggests the same folder as the original, but you can choose a different location. Rename the .bck to .tmv to open it normally.',
