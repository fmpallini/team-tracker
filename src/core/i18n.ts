...
const pt = {
  ...
  save_backup_tab_ok_title_daily: 'Backup diário ativo',
  save_backup_tab_ok_title_hourly: 'Backup a cada hora ativo',
  ...
  milestone_name_required: 'Este marco precisa de um nome.',
  ...
  risk_name_required: 'Este risco precisa de um nome.',
  /** Seeds a new risk's follow-up. {date} is an @[…](day:iso) mention linking to that day's daily note. */
  risk_created_on: 'Criado em {date}',
  ...
  help_global_daily_nav_content: 'Pular para o dia anterior / próximo que tem uma nota',
  ...
  backup_password_mismatch_toast: 'O backup pode ainda estar criptografado com a senha anterior — veja o indicador de salvamento para atualizá-lo',
  ...
  prefs_ctrl_wheel_font_label: 'Ctrl+roda do mouse ajusta o tamanho do texto',
  prefs_ctrl_wheel_font_hint: 'Desligado, Ctrl+rolagem usa o zoom normal do navegador.',
  prefs_daily_edge_scroll_label: 'Rolar além da borda de uma nota diária pula para o dia mais próximo com nota',
  size_toast: 'Tamanho do texto: {size}',
  ...
  data_cleanup_hint: 'Remove tarefas concluídas/canceladas e riscos encerrados, além de marcos concluídos e notas diárias com data anterior ao número de dias escolhido — em todos os times deste arquivo. Esta ação não pode ser desfeita.',
  data_cleanup_days_label: 'Excluir marcos concluídos e notas diárias com mais de (dias)',
  ...
  data_cleanup_nothing_body: 'Nenhum item concluído/cancelado, risco encerrado, marco concluído antigo ou nota diária antiga foi encontrado.',
...
const en: Record<MsgKey, string> = {
  ...
  save_backup_tab_ok_title_daily: 'Daily backup enabled',
  save_backup_tab_ok_title_hourly: 'Hourly backup enabled',
  ...
  milestone_name_required: 'This milestone needs a name.',
  ...
  risk_name_required: 'This risk needs a name.',
  /** Seeds a new risk's follow-up. {date} is an @[…](day:iso) mention linking to that day's daily note. */
  risk_created_on: 'Created on {date}',
  risk_col_title: 'Risk',
  risk_col_chance: 'Chance',
  ...
  help_global_daily_nav_content: 'Jump to the previous / next day that has a note',
  ...
  backup_password_mismatch_toast: 'The backup may still be encrypted with your previous password — see the save indicator to update it',
  ...
  prefs_ctrl_wheel_font_label: 'Ctrl+mouse wheel adjusts text size',
  prefs_ctrl_wheel_font_hint: 'When off, Ctrl+scroll uses the browser\'s normal zoom.',
  prefs_daily_edge_scroll_label: 'Scrolling past a daily note\'s edge jumps to the nearest day with a note',
  size_toast: 'Text size: {size}',
  ...
  data_cleanup_hint: 'Removes done/cancelled tasks and closed risks, plus completed milestones and daily notes dated older than the chosen number of days — across every team in this file. This cannot be undone.',
  ...
  data_cleanup_nothing_body: 'No done/cancelled tasks, closed risks, old completed milestones, or old daily notes were found.',
