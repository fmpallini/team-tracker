...
const pt = {
  ...
  prefs_backup_hint: 'Cria/atualiza um arquivo .bck na mesma pasta do arquivo original, no máximo uma vez a cada 24 horas — uma segunda linha de defesa contra corrupção de arquivo. Renomeie o .bck para .tmv para abri-lo normalmente.',
...
const en: Record<MsgKey, string> = {
  ...
  prefs_backup_hint: 'Creates/updates a .bck file in the same folder as the original, at most once every 24 hours — a second line of defense against file corruption. Rename the .bck to .tmv to open it normally.',
