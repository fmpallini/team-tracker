...
const pt = {
  ...
  kanban_card_context_hint: 'Clique com o botão direito para mais ações (duplicar, copiar/mover para outro time)',
...
const en: Record<MsgKey, string> = {
  ...
  kanban_card_context_hint: 'Right-click for more actions (duplicate, copy/move to another team)',
