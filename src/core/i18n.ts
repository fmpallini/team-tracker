...
const pt = {
  ...
  data_cleanup_hint: 'Remove itens de ação concluídos/cancelados, marcos concluídos e riscos encerrados, além de notas diárias antigas — em todos os times deste arquivo. Esta ação não pode ser desfeita.',
  ...
  data_cleanup_confirm_body: '{actions} itens de ação, {milestones} marcos, {risks} riscos e {dailyNotes} notas diárias em todos os times serão excluídos permanentemente. Esta ação não pode ser desfeita.',
...
const en: Record<MsgKey, string> = {
  ...
  data_cleanup_hint: 'Removes done/cancelled action items, completed milestones, and closed risks, plus old daily notes — across every team in this file. This cannot be undone.',
  ...
  data_cleanup_confirm_body: '{actions} action items, {milestones} milestones, {risks} risks, and {dailyNotes} daily notes across all teams will be permanently deleted. This cannot be undone.',
  data_cleanup_nothing_title: 'Nothing to clean up',
  data_cleanup_nothing_body: 'No done/cancelled action items, completed milestones, closed risks, or old daily notes were found.',
