...
### Added
- Person notes: the header now shows the person's role as a second line under their name, and gains two buttons — one edits their name and role in place without leaving the page, the other jumps to their box in the org chart (stakeholders or team members) and flashes it.
