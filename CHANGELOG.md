...
- Keyboard shortcuts: Ctrl+E for inline code, Ctrl+Shift+9 (or Ctrl+Shift+Q, for keyboards where the browser or a driver swallows the first) for blockquote, Ctrl+K to insert a link.
